...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::middleware('tenant')->group(function () {
            ...
            // Rutas de módulos
            Route::get('/empresa/modulos', [ModulesController::class, 'companyModules']);

            // Catálogo global y toggle (solo admin)
            Route::get('/modulos', [ModulesController::class, 'catalog'])
                ->middleware('role:admin');
            Route::post('/empresa/modulos/{key}/toggle', [ModulesController::class, 'toggle'])
                ->middleware('role:admin');
